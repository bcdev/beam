 ...
 * depending on the given {@link org.esa.beam.framework.datamodel.RasterDataNode}. The returned instance is optimised for the data type of the given
 * {@link org.esa.beam.framework.datamodel.RasterDataNode}.
 *
 * @author Marco Peters
 * @since BEAM 4.9.1
 */
